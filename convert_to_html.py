#!/usr/bin/env python3
"""
Convert bias_analysis_report.md to a beautiful HTML file
"""
...
<body>
    ...
    with open('bias_analysis_report.html', 'w', encoding='utf-8') as f:
        f.write(html_template)
    
    print("✅ HTML report created successfully: bias_analysis_report.html")
